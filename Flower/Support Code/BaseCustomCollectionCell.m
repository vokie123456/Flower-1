...
+(CellDataAdapter *)AdapterWithArray:(NSMutableArray *)array{
    return [CellDataAdapter collectionCellDataAdapterWithCellReuseIdentifier:NSStringFromClass([self class]) array:array cellType:0];
}
